!window.FAM && (function() {
  ...
  window.FAM = {
    ...
    config : {
      chat_page : 'https://glytest.forumactif.com/f3-wanted',
      chat_permission : 'all',  //  peut Ãªtre [all] ou [member] ou [staff]
      main_title : 'Messagerie',
      ...
      initial_tabs : [{
        url: 'https://glytest.forumactif.com/f2-gestionnaire',
        title: "Top sites"
      },
      {
        url: 'https://glytest.forumactif.com/f1-l-univers',
        title: "Flood"
      }
      ], 
      ...
      timeout : 2*60*1000, // Temps avant le mode veille (ici 10 minutes, 10*60*1000ms)
      flood_control : 5000, // Delais necessaire entre chaque message envoye, 0ms peut provoquer un message d'erreur (non recommande)
      max_attachments : 5, // Nombre de médias (image, gif, vidéo) qui peut être ajoutés par message

      ignore_announcements : true, // [false] pour voir les sujets d'annonces et de note, [true] pour les cacher
      ignore_firstpost : false, // [true] pour cacher le rappel du premier message, [false] pour l'afficher
      ...
      lang : {
        loading : 'Chargement',
        idle : 'La messagerie est en veille.<br> Cliquez pour reprendre.',
    ...
    console.log(attach, FAM.cache.actions);
      ...
      addGIF : function () {
        ...
        attach.innerHTML =
        '<div class="FAM-dropdown-inner">'+
          '<div class="FAM-dropdown-title"><span class="FAM-toolbar-button FAM-dropdown-back" onclick="FAM.attachments.back();"><i class="bi bi-arrow-left-short"></i></span>' + FAM.config.lang.attach_gif + '</div>'+
          '<div class="FAM-row">'+
      ...
      addVideo : function () {
        ...
        attach.innerHTML =
        '<div class="FAM-dropdown-inner">'+
          '<div class="FAM-dropdown-title"><span class="FAM-toolbar-button FAM-dropdown-back" onclick="FAM.attachments.back();"><i class="bi bi-arrow-left-short"></i></span>' + FAM.config.lang.attach_video + '</div>'+
          '<div class="FAM-button-input FAM-row">'+
      ...
      manage : function () {
        ...
        attach.innerHTML =
        '<div class="FAM-dropdown-inner">'+
          '<div class="FAM-dropdown-title"><span class="FAM-toolbar-button FAM-dropdown-back" onclick="FAM.attachments.back();"><i class="bi bi-arrow-left-short"></i></span>' + FAM.config.lang.attach_remove + '</div>'+
      ...
      open : function (caller) {
        ...
        '<div id="FAM-modal-content">'+
          '<div id="FAM-media-viewer">'+
            '<i id="FAM-modal-prev" class="FAM-modal-controls FAM-modal-arrows bi bi-arrow-left-short fa-2x" onclick="FAM.modal.showMedia(-1, true);" style="display:none;"></i>'+
            '<i id="FAM-modal-next" class="FAM-modal-controls FAM-modal-arrows bi bi-arrow-right-short fa-2x" onclick="FAM.modal.showMedia(+1, true);" style="display:none;"></i>'+
      ...
      function build () {
        ...
        FAM.select = {
          forumtitle : (FAM.fVersion == 6 ? '.forum-description h3 a[href^="/f"], .posts-description h3 a[href^="/t"]' : 
                        '.forum_content a.forum' + ( FAM.fVersion == 0 ? 'link' : 'title' ) + ', a.topictitle'),
          post : '.post_row',

          row : '.row',

          row_date : '.lastpost > .topicslist-lastpost-infos',
